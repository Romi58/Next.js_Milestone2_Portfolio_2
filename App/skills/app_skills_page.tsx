        ...
        {skills.map((skill, index) => (
          ...
          >
            <div className="flex items-center mb-4">
              <skill.icon className="text-4xl text-pink-500 mr-4" />
              <h3 className="text-xl font-semibold text-pink-500">{skill.name}</h3>
            </div>
            <div className="relative pt-1">
              <div className="flex mb-2 items-center justify-between">
                <div>
                  <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-white bg-pink-500">
                    {skill.percentage}%
                  </span>
                </div>
              </div>
